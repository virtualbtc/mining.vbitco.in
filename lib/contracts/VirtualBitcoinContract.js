...
class VirtualBitcoinContract extends Contract_1.default {
    ...
    async buyPizza(power) {
        var _a;
        const contract = await this.loadWalletContract();
        return await ((_a = this.contract) === null || _a === void 0 ? void 0 : _a.buyPizza(power));
    }
    async sellPizza(pizzaId) {
        var _a;
        const contract = await this.loadWalletContract();
        return await ((_a = this.contract) === null || _a === void 0 ? void 0 : _a.sellPizza(pizzaId));
    }
    async changePizza(pizzaId, power) {
        var _a;
        const contract = await this.loadWalletContract();
        return await ((_a = this.contract) === null || _a === void 0 ? void 0 : _a.changePizza(pizzaId, power));
    }
    ...
    async mine(pizzaId) {
        var _a;
        const contract = await this.loadWalletContract();
        return await ((_a = this.contract) === null || _a === void 0 ? void 0 : _a.mine(pizzaId));
    }
}
